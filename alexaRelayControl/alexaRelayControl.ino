...
String friendlyName = "relay";           // CHANGE: Alexa device name
const int relayPin = 4;                  // D1 pin. More info: https://github.com/esp8266/Arduino/blob/master/variants/d1_mini/pins_arduino.h#L49-L61
